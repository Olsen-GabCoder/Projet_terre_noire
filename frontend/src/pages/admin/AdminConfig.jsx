  ...
  return (
    <>
      <AdminTopbar
        ...
        subtitle="Gerez les parametres de livraison et autres reglages."
            ...
            <div style={{ background: '#fff', borderRadius: 14, border: '1px solid var(--tn-gray-200)', overflow: 'hidden' }}>
              <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--tn-gray-200)', display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: 12, color: 'var(--tn-gray-500)' }}>Configurez les couts et seuils de livraison</p>
                </div>
              </div>
              <div style={{ padding: 24, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                <div>
                  ...
                  <p style={{ fontSize: 11, color: 'var(--tn-gray-500)', marginTop: 4 }}>Applique si le panier est sous le seuil</p>
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'var(--tn-gray-700)', marginBottom: 6 }}>
              ...
              <div style={{ padding: '16px 24px', borderTop: '1px solid var(--tn-gray-100)', background: 'var(--tn-cream-2)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontSize: 12, color: 'var(--tn-gray-600)' }}>
                  ...
                  Actuellement : {fmtPrice(config.shipping_cost)} FCFA de frais, gratuit des {fmtPrice(config.shipping_free_threshold)} FCFA
                </span>
